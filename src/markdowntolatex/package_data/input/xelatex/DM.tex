...
\documentclass[MarkdownToLaTeX:paper,MarkdownToLaTeX:size,titlepage,openany,leqno]{MarkdownToLaTeX:class}
...
\newfontfamily{\MarkdownToLaTeX:mainfontalias}{MarkdownToLaTeX:mainfontname}
...
%\usepackage{mathspec}
\def\mainfont{MarkdownToLaTeX:mainfontname}
...
%--------------END OF PRIMITIVES--------------------------------
\def\ROOT{MarkdownToLaTeX:root}
\def\TITLE{MarkdownToLaTeX:title}
\def\EMAIL{MarkdownToLaTeX:email}
\def\AUTHOR{MarkdownToLaTeX:author}
